...
If infrastructure.yaml has a "lambdaFunctions" section, apply these rules only to functions whose existing "runtime" starts with "dotnet" (for example dotnet6 or dotnet8):
